...
public enum ParticleEffect {
     ...
     */
    public void display(Location center, float offsetY, float offsetZ, float speed, int amount, float offsetX, double range) throws ParticleVersionException, ParticleDataException, IllegalArgumentException {
        if (!isSupported()) {
